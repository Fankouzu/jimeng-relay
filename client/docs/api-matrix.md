...
| `i2v-first-720` | `jimeng_i2v_first_v30` | `i2v-first-frame` | 图生视频 (首帧) 720p |
| `i2v-first` | `jimeng_i2v_first_v30_1080` | `i2v-first-frame` | 图生视频 (首帧) 1080p |
| `i2v-first-tail-720` | `jimeng_i2v_first_tail_v30` | `i2v-first-tail` | 图生视频 (首尾帧) 720p |
| `i2v-first-tail` | `jimeng_i2v_first_tail_v30_1080` | `i2v-first-tail` | 图生视频 (首尾帧) 1080p |
